...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="skins/sky/import_skin.css" rel="stylesheet" type="text/css" themeColor="blue"/>
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="no" width="100%" frameBorder=0 id=frmleft name=frmleft src="quanxian?username=<%=s%>" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="./jspPage/underMain/huanying.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
