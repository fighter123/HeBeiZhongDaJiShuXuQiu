...
<table width="820" border="1"  cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse;">
  <tbody>
    ...
    <tr id="jichuxinxi1" style=" display:none ">
      ...
      <td colspan="2"><input type="text"  style="width: 80% ; border-style: 1; margin-left:1px "  tabindex="1" name="companyAllname" id="jgname" value=<s:property value="user.compnyname"/> required>   		
      </td>
      <td>&nbsp;归口管理部门</td>
      <td colspan="3"> 
      		<div class="nice-select">
				<input id="gkbm" name="belongApartment" value=<s:property value="user.belongapartment"/> type="text" oninput="searchList(this.value)" onclick="tanchu2()"/>
				<ul>
    ...
    <tr id="jichuxinxi2" style=" display:none ">
      ...
      <td colspan="2"><input name="companyAdrss" id="companyAdrss" type="text" style="width: 80%; margin-left:1px "textfield" tabindex="2" autocomplete="off" value=<s:property value="user.adress"/> required></td>
      <td><span style="color: red">*</span>所在地域</td>   
      <td colspan="3">
	      <select style=" width:188px;margin-left:1px " size="1" name="area" id="area" value=<s:property value="user.area"/> required>
    ...
    <tr id="jichuxinxi3" style=" display:none ">
      ...
      <td colspan="2" nowrap><input type="text" style="width: 80%; margin-left:1px " name="web" id="web"  value=<s:property value="user.web"/>></td>
      <td width="115"><span style="color: red">*</span>电子信箱</td>
      <td colspan="3"><input onblur="verifyAddress()" name="email" type="text" style=" width:182px;margin-left:1px " id="email" size="18"  tabindex="4" value=<s:property value="user.email"/> required>
        <label><div id="mes" nowrap>填写邮箱!</div></label>
        </td>    	
    </tr>
      <tr id="jichuxinxi4" style=" display:none ">
        <td height="42"><span style="color: red">*</span>法人代表</td>
        <td colspan="2"><input  type="text" style="width: 80%; margin-left:1px " name="faRen"  id="faren" value=<s:property value="user.realname"/> required></td>
        <td>&nbsp;邮政编码</td>
        <td colspan="4"><input onblur="youbiantest()" type="text" style=" width:182px;margin-left:1px " name="youBian" id="youbian" size="18">
        <label><div id="yb" nowrap>填写邮编!</div></label></td>
      </tr>
      <tr id="jichuxinxi8" style=" display:none ">
        <td height="42">&nbsp;联 系 人</td>
        <td width="188" colspan="2"><input  onblur="PeopleYanzheng()" type="text" style="width: 80%; margin-left:1px " name="lianXiRen" id="People"  value=<s:property value="user.realname"/>>
        <!-- <div id="mesPeople" nowrap></div> -->
        </td>
        <td>&nbsp;固定电话</td>
        <td><input type="text" style=" width:182px;margin-left:1px " name="tell" id="textfield5"   value=<s:property value="user.tell"/>></td>
      </tr>
      <tr id="jichuxinxi5" style=" display:none ">
      	<td height="42">&nbsp;手机</td>
        <td width="126" colspan="2"><input type="text"  name="phone" style="width: 80%; margin-left:1px " id="textfield13" size="15"  value=<s:property value="user.phone"/>></td>      
        <td height="31">&nbsp;传真</td>
        <td colspan="4"><input type="text" style=" width:182px;margin-left:1px " name="fax" id="textfield6" size="18"  value=<s:property value="user.fax"/>></td>
        </tr>
      ...
      <td colspan="6"><table width="415">
        <tr>
          <td width="91"><label>
            <input type="radio" name="jiGouShuXing" value="企业" id="CheckboxGroup1_0" <s:if test="user.about=='企业'">checked</s:if> required>
            企业
          </label></td>
          <td width="95"><input type="radio" name="jiGouShuXing" value="高等院校" id="CheckboxGroup1_1" <s:if test="user.about=='高等院校'">checked</s:if>>
            高等院校</td>
          <td width="112"><input type="radio" name="jiGouShuXing" value="研究机构" id="CheckboxGroup1_2" <s:if test="user.about=='研究机构'">checked</s:if>>
            研究机构</td>
          <td width="97"><input type="radio" name="jiGouShuXing" value="其他" id="CheckboxGroup1_3" <s:if test="user.about=='其他'">checked</s:if>>
            其他</td>
        </tr>
      </table></td>
    </tr>
    <tr id="jichuxinxi7" style=" display:none ">
      <td height="69" colspan="7">
       <p ><span style="color: red">*</span>机构简介（单位基本情况，研究基础等，限200字）<strong> </strong></p>
        <label><textarea placeholder="*机构简介（单位基本情况，研究基础等，限200字）" style="font-size: 18px; font-family:宋体;" name="jiGouJianJie" id="jianjie"  cols="28" rows="5" oninput="textCounter(jianjie,remLen,200);" onKeyUp="textCounter1(jianjie,remLen,200);"><s:property value="user.about"/></textarea>
        <p></p>
    ...
    <tr>
      ...
      <td colspan="2"><input type="text" style="" name="xuQiuName" id="xuQiuName" required></td>
    ...
    <tr>
      <td colspan="7">
          ...
          <label><br>
            <textarea placeholder="*重大科技需求概述（主要内容，技术指标、预期经济和社会效益等，限500字"  style=";font-size: 18px; font-family:宋体;" name="gaiShu1" id="gaishu1" cols="28" rows="5" oninput="textCounter(gaishu1,jishu,500);" onKeyUp="textCounter(gaishu1,jishu,500);" required></textarea>
        ...
        个字符
          ...
          <label><br>
          <textarea placeholder="*重大科技需求概述（主要内容，技术指标、预期经济和社会效益等，限500字"  style=";font-size: 18px; font-family:宋体;" name="gaiShu2" id="gaishu2" cols="28" rows="5" oninput="textCounter(gaishu2,jishu2,500);" required></textarea>
        ...
        个字符
          ...
          <label>  <br>
            <textarea placeholder="*重大科技需求概述（主要内容，技术指标、预期经济和社会效益等，限500字"  style=";font-size: 18px; font-family:宋体;" name="gaiShu3" id="gaishu3" cols="28" rows="5" oninput="textCounter(gaishu3,jishu3,500);" required></textarea>
        ...
        个字符
          ...
          <p></p>
   		     ...
   		     <input onKeyDown="iptdisplay();" onKeyUp="iptdisplay();" type="text" name="guanjianzi1" maxlength="5" id="guanjianzi1" size="9" required> ⇨
    ...
    <tr>
      ...
      <td colspan="6"><input type="text" style="" name="sumMoney" id="summoney">
        万元</td>
    </tr>
    <tr>
      <td rowspan="2"><p ><span style="color: red">*</span>技术需求解决方式 </p></td>
      <td height="32" colspan="6"><input type="radio" name="way" id="checkbox19" value="独立研发" required>
        独立研发
        <input type="radio" name="way" id="checkbox21" value="委托研发">
委托研发
<input type="radio" name="way" id="checkbox22" value="合作研发">
合作研发
          <input type="radio" name="way" id="checkbox23" value="其他">
其他</td>
    </tr>
    <tr>
...
(非必填)</td>
    ...
    <tr>
      ...
      <td colspan="6"><table width="632" height="60" border="0">
        <tbody>
          <tr>
            <td width="178"><input type="radio" name="huoDongLeiXing" id="checkbox1" value="基础研究" onclick="radio_click2()" required>
基础研究 </td>
            <td width="175"><input type="radio" name="huoDongLeiXing" id="checkbox2" value="应用研究" onclick="radio_click1()">
应用研究</td>
            <td width="265"><input type="radio" name="huoDongLeiXing" id="checkbox3" value="试验发展" onclick="radio_click1()">
              试验发展</td>
            </tr>
          <tr>
            <td height="26"><input type="radio" name="huoDongLeiXing" id="checkbox4" value="研究发展与成果应用" onclick="radio_click1()">
研究发展与成果应用</td>
            <td><input type="radio" name="huoDongLeiXing" id="checkbox5" value="技术推广与科技服务" onclick="radio_click1()">
技术推广与科技服务</td>
            <td><input type="radio" name="huoDongLeiXing" id="checkbox16" value="技术推广与科技服务" onclick="radio_click1()">
              生产性活动</td>
            </tr>
        </tbody>
      </table></td>     
