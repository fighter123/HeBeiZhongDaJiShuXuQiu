...
需求单号：<input type="text" id="xuQiuNum" value=<s:property value="xuQiu.xuQiuNum"/> style="border:0px;background-color:transparent" readonly/><br><p></p>
...
<!------------------------需求技术所属领 --------------------------------------------------------------------------------------->
<s:if test="xuQiu.suoShuLingYu!=null">  
    <tr id="jx">
      <td height="50">&nbsp;需求技术所属领</td>
      <td colspan="6">
...
<p>	 
	 <div class="demo_con">
     <input type="button" class="buttonblue" name="submit" id="saveAndCommit" value="通过">
     <input type="button" class="buttonblue" name="submit" id="justSave" value="不通过">
     </div>	
</p>
<input id="state" type="hidden" value=<s:property value="xuQiu.state"/>>
 </form>
</center>
</body>
